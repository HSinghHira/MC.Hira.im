...
export const head: HeadConfig[] = [
  ...
  [
    ...
    {
      name: "keywords",
      content: "Minecraft, mods, tutorials, Meteor Client, modding, gaming",
    },
  ],
  [
    "meta",
    {
      ...
      content: "oQMdsS94GsVMXmnVVFsxY4syJf656ZWAXRu_g_fQIY8",
    },
  ],
  // Open Graph
  ...
  ["meta", { property: "og:image", content: "/data/social/card.png" }],
  // Twitter Card
  ...
  ["meta", { name: "twitter:image", content: "/data/social/card.png" }],
  [
    "meta",
    {
      name: "twitter:image:alt",
      content:
        "All About Minecraft - Discover the latest Minecraft client addons, mods, and tools on MC.Hira.im.",
    },
  ],
  // Links
...
export const transformHead = ({ pageData }: TransformContext): HeadConfig[] => {
  ...
  const title =
    pageData.frontmatter.title || pageData.title || "All About Minecraft";
  const description =
    pageData.frontmatter.description ||
    pageData.description ||
    "Discover the latest Minecraft client addons, mods, and tools on MC.Hira.im. Stay updated with curated content, installation guides, and support for the Meteor Client.";
  const defaultKeywords =
    "Minecraft, mods, tutorials, Meteor Client, modding, gaming";
  ...
  const lastModified = pageData.lastUpdated
  ...
  if (pageData.relativePath.startsWith("en/")) {
    ...
    if (pbUrlPath && !pbUrlPath.endsWith("/") && !pbUrlPath.includes("."))
      pbUrlPath = pbUrlPath + "/";
    ...
    if (enUrlPath && !enUrlPath.endsWith("/") && !enUrlPath.includes("."))
      enUrlPath = enUrlPath + "/";
